...
import os
import sys
print("🚀 ExternalAttacker-MCP.py started", file=sys.stderr)
...
@mcp.tool()
async def scan_subdomains(target: str, domain_file: bool, threads: int = 100):
    """
...
if __name__ == "__main__":
    ...
    # Prevent early exit for debugging / orchestration
    import time
    while True:
        time.sleep(1)
